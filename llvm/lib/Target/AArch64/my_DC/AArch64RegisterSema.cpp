...
Type *AArch64RegisterSema::getRegType(unsigned RegNo) {
  return Type::getInt64Ty(*unwrap(LLVMGetGlobalContext()));
}
...
Value *AArch64RegisterSema::getReg(unsigned RegNo) {
  ...
  if (RegNo >= AArch64::Q0_Q1 && RegNo <= AArch64::Q31_Q0) {
    ...
    Reg1 = Builder->CreateZExt(Reg1, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 256));
    Reg2 = Builder->CreateZExt(Reg2, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 256));
  ...
  if (RegNo >= AArch64::D0_D1 && RegNo <= AArch64::D31_D0) {
    ...
    Reg1 = Builder->CreateZExtOrTrunc(Reg1, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 128));
    Reg2 = Builder->CreateZExtOrTrunc(Reg2, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 128));
  ...
  if (RegNo >= AArch64::Q0_Q1_Q2 && RegNo <= AArch64::Q31_Q0_Q1) {
    ...
    Reg1 = Builder->CreateZExt(Reg1, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 384));
    Reg2 = Builder->CreateZExt(Reg2, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 384));
    Reg2 = Builder->CreateShl(Reg2, 128);
    Reg3 = Builder->CreateZExt(Reg3, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 384));
  ...
  if (RegNo >= AArch64::D0_D1_D2 && RegNo <= AArch64::D31_D0_D1) {
    ...
    Reg1 = Builder->CreateZExt(Reg1, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 192));
    Reg2 = Builder->CreateZExt(Reg2, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 192));
    Reg2 = Builder->CreateShl(Reg2, 64);
    Reg3 = Builder->CreateZExt(Reg3, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 192));
  ...
  if (RegNo >= AArch64::Q0_Q1_Q2_Q3 && RegNo <= AArch64::Q31_Q0_Q1_Q2) {
    ...
    Reg1 = Builder->CreateZExt(Reg1, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 512));
    Reg2 = Builder->CreateZExt(Reg2, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 512));
    Reg2 = Builder->CreateShl(Reg2, 128);
    Reg3 = Builder->CreateZExt(Reg3, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 512));
    Reg3 = Builder->CreateShl(Reg3, 256);
    Reg4 = Builder->CreateZExt(Reg4, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 512));
  ...
  if (RegNo >= AArch64::D0_D1_D2_D3 && RegNo <= AArch64::D31_D0_D1_D2) {
    ...
    Reg2 = Builder->CreateZExt(Reg2, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 256));
    Reg2 = Builder->CreateShl(Reg2, 64);
    Reg3 = Builder->CreateZExt(Reg3, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 256));
    Reg3 = Builder->CreateShl(Reg3, 128);
    Reg4 = Builder->CreateZExt(Reg4, IntegerType::get(*unwrap(LLVMGetGlobalContext()), 256));
